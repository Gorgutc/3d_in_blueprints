...
Do not judge visuals from source alone.

## Requirement

Require a screenshot, local URL, rendered artifact, or explicit user-provided
visual reference before giving a visual PASS.
