...
Use only with a rendered screenshot or local URL.

## Output

Report the first impression, target audience fit, blockers, and concrete fixes.
If no visual input exists, ask for one instead of guessing.
